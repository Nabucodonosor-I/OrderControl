...
import com.ordercontrol.ui.TelaPrincipal;
    ...
    public class TelaAdmin extends TelaPrincipal implements AdjustmentListener {
        ...
        private final RoundedButton addButton = new RoundedButton(20, new Color(54, 54, 54), null);
